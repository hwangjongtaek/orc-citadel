...
| 앱셸 | 나머지 6공간 | `aspect-ratio: 8/3` · 상한 **300px** | `fill` (패널 독립 스크롤) |
| 히어로 없음 | index · empty-states | 132px 평평한 그라데이션 밴드 | `fill` |

**상한은 필수다.** 8:3 을 상한 없이 두면 1519px 뷰포트에서 570px, 2560px 뷰포트에서는 **960px** 을 먹어 본문이 통째로 밀린다. 앱셸이 300px 로 더 낮은 것은 3열 본문에 세로를 남기기 위해서다 — 그래도 원본 132px 보다 장면이 훨씬 잘 읽힌다. 잘리는 곳은 천장 창살·바닥 카펫으로 장면에서 정보량이 가장 적은 부분이다.
